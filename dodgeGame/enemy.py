...
class Enemy:
    def __init__(self, window_width, window_height, x=0, y=0, color=(255, 255, 255), max_speed=2.5, max_radius=50):
    ...
    def move(self, playerCoords=None):
        ...
        if playerCoords is not None:
            ...
            dx = self.speed * (playerCoords[0] - self.x) / dist_to_target
            dy = self.speed * (playerCoords[1] - self.y) / dist_to_target
